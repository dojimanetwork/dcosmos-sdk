...
func BenchmarkOneBankSendTxPerBlock(b *testing.B) {
	...
	ctx := benchmarkApp.BaseApp.NewContext(false, dtmproto.Header{})
	...
	for i := 0; i < b.N; i++ {
		benchmarkApp.BeginBlock(dabci.RequestBeginBlock{Header: dtmproto.Header{Height: height}})
		...
		require.NoError(b, err)
		benchmarkApp.EndBlock(dabci.RequestEndBlock{Height: height})
		benchmarkApp.Commit()
		height++
	}
}

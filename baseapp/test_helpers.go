...
func (app *BaseApp) NewContext(isCheckTx bool, header dtmproto.Header) sdk.Context {
	if isCheckTx {
...
func (app *BaseApp) NewUncachedContext(isCheckTx bool, header dtmproto.Header) sdk.Context {

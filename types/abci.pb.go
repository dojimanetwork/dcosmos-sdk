...
const (
	...
	CodeType_CODE_TYPE_OK_UNSPECIFIED CodeType = 0
)

var CodeType_name = map[int32]string{
	0: "CODE_TYPE_OK_UNSPECIFIED",
}

var CodeType_value = map[string]int32{
	"CODE_TYPE_OK_UNSPECIFIED": 0,
}
...
type Result struct {
	...
	Code CodeType `protobuf:"varint,3,opt,name=code,proto3,enum=cosmos.base.abci.v1beta1.CodeType" json:"code,omitempty"`
	// Events contains a slice of Event objects that were emitted during message
	// or handler execution.
	Events []types1.Event `protobuf:"bytes,4,rep,name=events,proto3" json:"events"`
}
...
func init() {
	proto.RegisterEnum("cosmos.base.abci.v1beta1.CodeType", CodeType_name, CodeType_value)
...
var fileDescriptor_4e37629bc7eb0df8 = []byte{
	...
	,
}
